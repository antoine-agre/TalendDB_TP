...
package tp_archiservices_icy.rest_api_create_user_0_1;
...
/**
 * Job: REST_API_Create_User Purpose: Recevoir des requêtes POST permettant de
 * créer des utilisateurs dans la base de données<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class REST_API_Create_User implements TalendJob {
	...
	private final String jobName = "REST_API_Create_User";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					REST_API_Create_User.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(REST_API_Create_User.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private final REST_API_Create_User job;

		public RestServiceProviderImpl4TalendJob(REST_API_Create_User job) {
			this.job = job;
		}

		private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap,
				REST_API_Create_User job) {
		...
		public javax.ws.rs.core.Response request(
			...
			request_tRESTRequest_1.put("PATTERN", "/users");
	...
	class Thread4RestServiceProviderEndpoint extends Thread {
		...
		public Thread4RestServiceProviderEndpoint(REST_API_Create_User job, String endpointUrl) {
			this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = REST_API_Create_User.class.getClassLoader().getResourceAsStream(
					"tp_archiservices_icy/rest_api_create_user_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = REST_API_Create_User.class.getClassLoader()
	...
	public static class responseStruct implements routines.system.IPersistableRow<responseStruct> {
		final static byte[] commonByteArrayLock_TP_ARCHISERVICES_ICY_REST_API_Create_User = new byte[0];
		static byte[] commonByteArray_TP_ARCHISERVICES_ICY_REST_API_Create_User = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP_ARCHISERVICES_ICY_REST_API_Create_User) {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP_ARCHISERVICES_ICY_REST_API_Create_User.length) {
					if (length < 1024 && commonByteArray_TP_ARCHISERVICES_ICY_REST_API_Create_User.length == 0) {
						commonByteArray_TP_ARCHISERVICES_ICY_REST_API_Create_User = new byte[1024];
					} else {
						commonByteArray_TP_ARCHISERVICES_ICY_REST_API_Create_User = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP_ARCHISERVICES_ICY_REST_API_Create_User, 0, length);
				strReturn = new String(commonByteArray_TP_ARCHISERVICES_ICY_REST_API_Create_User, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP_ARCHISERVICES_ICY_REST_API_Create_User, 0, length);
				strReturn = new String(commonByteArray_TP_ARCHISERVICES_ICY_REST_API_Create_User, 0, length,
						utf8Charset);
			}
			return strReturn;
	...
	public void tRESTRequest_1_LoopProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (execStat) {
					runStat.updateStatOnConnection(iterateId, 0, 0, "request", "user", "row1", "response");
				}
...
// # Outputs initialization
					...
					userStruct user_save = null;
//the aggregate variable
					userStruct user_aggregate = null;
					...
					if (requestMessage_tRESTRequest_1.containsKey("ERROR")) { // wrong request received
						...
						if (matchedFlow_tRESTRequest_1.equals("request")) {
							...
							if (null != bodyObject_tRESTRequest_1) {
								...
								request.body = body_tRESTRequest_1;
...
// Start of branch "request"
					if (request != null) {
						...
						if (request.body == null || request.body.getDocument() == null) {
							throw new RuntimeException("request.body can't be empty");
						}
						org.dom4j.Document doc_tXMLMap_1_TXMLMAP_OUT = request.body.getDocument();
						...
						absolutePathMappings_tXMLMap_1_TXMLMAP_OUT[0] = "request.body:/root/prenom";
						relativePathMappings_tXMLMap_1_TXMLMAP_OUT[0] = "prenom";

						absolutePathMappings_tXMLMap_1_TXMLMAP_OUT[1] = "request.body:/root/nom";
						relativePathMappings_tXMLMap_1_TXMLMAP_OUT[1] = "nom";
						...
						for (java.util.Map<String, String> oneRow_tXMLMap_1_TXMLMAP_OUT : resultSet_tXMLMap_1_TXMLMAP_OUT) { // G_TXM_M_001
							...
							{ // start of Var scope
								...
								Var.nom = StringHandling
										.TRIM(treeNodeAPI_tXMLMap_1_TXMLMAP_OUT.get_String("request.body:/root/nom"));

								Var.prenom = StringHandling.TRIM(
										treeNodeAPI_tXMLMap_1_TXMLMAP_OUT.get_String("request.body:/root/prenom"));

								Var.login = StringHandling.DOWNCASE(TalendString.removeAccents(Var.nom)) + "-"
										+ StringHandling.LEFT(
												StringHandling.DOWNCASE(TalendString.removeAccents(Var.prenom)), 1);

								Var.password = TalendString.getAsciiRandomString(16);
								// ###############################
								// # Output tables
...
// # Output table : 'user'
								...
								user_tmp = new userStruct();
								user_tmp.nom = Var.nom;
								user_tmp.prenom = Var.prenom;
								user_tmp.login = Var.login;
								user_tmp.password = Var.password;
								allOutsForAggregate_tXMLMap_1.add(user_tmp);
...
//    	this.treeNodeAPI = treeNodeAPI;
						...
						// input table.
						void generateElements(boolean isInnerJoin, row1Struct row1, Var__tXMLMap_2__Struct Var) {
...
// build root xml tree 
							if (needRoot) {
								...
								root_0 = root.addElement("nom");
								valueMap.put("root_0", row1.nom);
								...
								root_1 = root.addElement("prenom");
								valueMap.put("root_1", row1.prenom);
								...
								root_2 = root.addElement("login");
								valueMap.put("root_2", row1.login);
								...
								root_3 = root.addElement("password");
								valueMap.put("root_3", row1.password);
					...
					String url_tDBOutput_1 = "jdbc:postgresql://" + "localhost" + ":" + "5432" + "/" + "Users";
					dbUser_tDBOutput_1 = "postgres";

					final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
							"enc:routine.encryption.key.v1:V8M1Ids/nWWGndQBmuvxW9/hjf3vGP/kcf6s1dlk4nWkyArP");
					...
					for (Object row_out_tXMLMap_1_TXMLMAP_IN : outs_tXMLMap_1) {// TD512
						...
						if (row_out_tXMLMap_1_TXMLMAP_IN != null
								&& row_out_tXMLMap_1_TXMLMAP_IN instanceof userStruct) {
							user = (userStruct) row_out_tXMLMap_1_TXMLMAP_IN;
						}
...
// Start of branch "user"
						if (user != null) {
							...
							if (user.nom == null) {
								...
								pstmt_tDBOutput_1.setString(1, user.nom);
							}

							if (user.prenom == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(2, user.prenom);
							}

							if (user.login == null) {
								pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(3, user.login);
							}

							if (user.password == null) {
								pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(4, user.password);
							}
							...
							if (!whetherReject_tDBOutput_1) {
								row1 = new row1Struct();
								row1.nom = user.nom;
								row1.prenom = user.prenom;
								row1.login = user.login;
								row1.password = user.password;
							}
...
// Start of branch "row1"
							if (row1 != null) {
								...
								GenerateDocument_response gen_Doc_response_tXMLMap_2 = new GenerateDocument_response();
...
// # Output table : 'response'
									...
									gen_Doc_response_tXMLMap_2.generateElements(rejectedDocInnerJoin_tXMLMap_2, row1,
											Var);

									if (response_tmp.body == null) {
										response_tmp.body = new routines.system.Document();
										response_tmp.body.setDocument(gen_Doc_response_tXMLMap_2.getDocument());
									}
...
// Start of branch "response"
				...
				if (execStat) {
					runStat.updateStatOnConnection(iterateId, 2, 0, "request", "user", "row1", "response");
				}
	...
	public static void main(String[] args) {
		final REST_API_Create_User REST_API_Create_UserClass = new REST_API_Create_User();

		int exitCode = REST_API_Create_UserClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = REST_API_Create_User.class.getClassLoader().getResourceAsStream(
					"tp_archiservices_icy/rest_api_create_user_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = REST_API_Create_User.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : REST_API_Create_User");
		}
...
/************************************************************************************************
 * 115197 characters generated by Talend Open Studio for ESB on the 25 janvier
 * 2024, 10:28:20 CET
 ************************************************************************************************/