...
package tp_archiservices_icy.soap_ws_get_user_by_login_0_1;
...
/**
 * Job: SOAP_WS_Get_User_By_Login Purpose: Exposer un web service SOAP
 * permettant d'interroger la base de données et de récupérer un utilisateur
 * précis à partir de son login<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class SOAP_WS_Get_User_By_Login implements TalendJob, TalendESBJob, TalendESBJobFactory {
	...
	public TalendESBJob newTalendESBJob() {
		SOAP_WS_Get_User_By_Login talendESBJob = new SOAP_WS_Get_User_By_Login();
	...
	private final String jobName = "SOAP_WS_Get_User_By_Login";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					SOAP_WS_Get_User_By_Login.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(SOAP_WS_Get_User_By_Login.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = SOAP_WS_Get_User_By_Login.class.getClassLoader().getResourceAsStream(
					"tp_archiservices_icy/soap_ws_get_user_by_login_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = SOAP_WS_Get_User_By_Login.class.getClassLoader()
	...
	public ESBEndpointInfo getEndpoint() {
		return new ESBEndpointInfo() {
			...
			private java.util.Map<String, Object> props = new java.util.HashMap<String, Object>() {
				{
					...
					put("portName", "{http://www.talend.org/service/}GetUserByLoginWSPort");
					put("serviceName", "{http://www.talend.org/service/}GetUserByLoginWS");
					put("defaultOperationName", "GetUserByLoginWSOperation");
					put("defaultOperationNameSpace", "http://www.talend.org/service/");
					put("publishedEndpointUrl", "http://localhost:8090/services/GetUserByLoginWS");
				}
			};
			...
			public String getEndpointUri() {
				...
				return "TP_ARCHISERVICES_ICY_SOAP_WS_Get_User_By_Login";
			}
	...
	class HandlerThread_tESBProviderRequest_1 extends Thread {
		...
		String endpointUrl = "http://localhost:8090/services/GetUserByLoginWS";
		...
		public void run() {
			...
			serverFactory
					.setWsdlURL("C:/TOSESB/Studio/workspace/TP_ARCHISERVICES_ICY/services/GetUserByLoginWS_0.1.wsdl");
			serverFactory.setServiceName(
					new javax.xml.namespace.QName("http://www.talend.org/service/", "GetUserByLoginWS"));
			serverFactory.setEndpointName(
					new javax.xml.namespace.QName("http://www.talend.org/service/", "GetUserByLoginWSPort"));
	...
	public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
		final static byte[] commonByteArrayLock_TP_ARCHISERVICES_ICY_SOAP_WS_Get_User_By_Login = new byte[0];
		static byte[] commonByteArray_TP_ARCHISERVICES_ICY_SOAP_WS_Get_User_By_Login = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP_ARCHISERVICES_ICY_SOAP_WS_Get_User_By_Login.length) {
					if (length < 1024 && commonByteArray_TP_ARCHISERVICES_ICY_SOAP_WS_Get_User_By_Login.length == 0) {
						commonByteArray_TP_ARCHISERVICES_ICY_SOAP_WS_Get_User_By_Login = new byte[1024];
					} else {
						commonByteArray_TP_ARCHISERVICES_ICY_SOAP_WS_Get_User_By_Login = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP_ARCHISERVICES_ICY_SOAP_WS_Get_User_By_Login, 0, length);
				strReturn = new String(commonByteArray_TP_ARCHISERVICES_ICY_SOAP_WS_Get_User_By_Login, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP_ARCHISERVICES_ICY_SOAP_WS_Get_User_By_Login, 0, length);
				strReturn = new String(commonByteArray_TP_ARCHISERVICES_ICY_SOAP_WS_Get_User_By_Login, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readKeysData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP_ARCHISERVICES_ICY_SOAP_WS_Get_User_By_Login) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// linked node: tXMLMap_2 - inputs:(row1,row2) outputs:(response)
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:CBps+N9RVBiXC6XHXY3NkuDxHXyIEHlLb2HT8Fh9f7TfBiqs");
				...
				String dbquery_tDBInput_1 = "SELECT \n  \"public\".\"User\".\"id\", \n  \"public\".\"User\".\"nom\", \n  \"public\".\"User\".\"prenom\", \n  \"public\"."
						+ "\"User\".\"login\", \n  \"public\".\"User\".\"password\"\nFROM \"public\".\"User\"\nWHERE \"public\".\"User\".\"login\" LI"
						+ "KE '%" + globalMap.get("login") + "%'";
...
// ###############################
							...
							class GenerateDocument_response {
								...
								TreeNode_API_tXMLMap_2_TXMLMAP_OUT treeNodeAPI = null;
...
//    	this.treeNodeAPI = treeNodeAPI;
								...
								// input table.
								void generateElements(TreeNode_API_tXMLMap_2_TXMLMAP_OUT treeNodeAPI,
...
// build root xml tree 
									if (needRoot) {
										...
										root = doc.addElement("tns:GetUserByLoginWSOperationResponse");
										...
										routines.system.DocumentHelper.applyNamespace2(root,
												"GetUserByLoginWSOperationResponse", "tns",
							...
							GenerateDocument_response gen_Doc_response_tXMLMap_2_TXMLMAP_OUT = new GenerateDocument_response();
							...
							gen_Doc_response_tXMLMap_2_TXMLMAP_OUT = new GenerateDocument_response();
							...
							docToFlat_tXMLMap_2_TXMLMAP_OUT
									.setOriginalLoop("/tns:GetUserByLoginWSOperationRequest/login");
							...
							org.dom4j.Document doc_tXMLMap_2_TXMLMAP_OUT = row1.payload.getDocument();
							...
							xmlNameSpaceMap_tXMLMap_2_TXMLMAP_OUT.put("tns", "http://www.talend.org/service/");
							...
							absolutePathMappings_tXMLMap_2_TXMLMAP_OUT[0] = "row1.payload:/tns:GetUserByLoginWSOperationRequest/login";
							...
							for (java.util.Map<String, String> oneRow_tXMLMap_2_TXMLMAP_OUT : resultSet_tXMLMap_2_TXMLMAP_OUT) { // G_TXM_M_001
								...
								/////////////////////////////////////////////// "org.talend.designer.xmlmap.model.emf.xmlmap.impl.InputXmlTreeImpl@6b375758
								...
								row2HashKey.login = treeNodeAPI_tXMLMap_2_TXMLMAP_OUT
										.get_String("row1.payload:/tns:GetUserByLoginWSOperationRequest/login");
								row2HashKey.hashCodeDirty = true;

								if (!rejectedInnerJoin_tXMLMap_2_TXMLMAP_OUT) {// TD120

									globalMap.put("login", treeNodeAPI_tXMLMap_2_TXMLMAP_OUT
											.get_String("row1.payload:/tns:GetUserByLoginWSOperationRequest/login"));
...
// # Output table : 'response'
									...
									gen_Doc_response_tXMLMap_2_TXMLMAP_OUT.generateElements(
											treeNodeAPI_tXMLMap_2_TXMLMAP_OUT,
											rejectedDocInnerJoin_tXMLMap_2_TXMLMAP_OUT, row1, row2, Var);

									if (response_tmp.payload == null) {
										response_tmp.payload = new routines.system.Document();
										response_tmp.payload
												.setDocument(gen_Doc_response_tXMLMap_2_TXMLMAP_OUT.getDocument());
//construct the resultset when there is no aggregate column for the out table
										allOutsForAggregate_tXMLMap_2.add(response_tmp);
									}
...
// ###############################
							...
							for (Object row_out_tXMLMap_2_TXMLMAP_IN : outs_tXMLMap_2) {// TD512
								...
								if (row_out_tXMLMap_2_TXMLMAP_IN != null
										&& row_out_tXMLMap_2_TXMLMAP_IN instanceof responseStruct) {
									response = (responseStruct) row_out_tXMLMap_2_TXMLMAP_IN;
...
// Start of branch "response"
	...
	public static void main(String[] args) {
		final SOAP_WS_Get_User_By_Login SOAP_WS_Get_User_By_LoginClass = new SOAP_WS_Get_User_By_Login();

		int exitCode = SOAP_WS_Get_User_By_LoginClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = SOAP_WS_Get_User_By_Login.class.getClassLoader().getResourceAsStream(
					"tp_archiservices_icy/soap_ws_get_user_by_login_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = SOAP_WS_Get_User_By_Login.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : SOAP_WS_Get_User_By_Login");
		}
...
/************************************************************************************************
 * 103190 characters generated by Talend Open Studio for ESB on the 25 janvier
 * 2024, 11:35:01 CET
 ************************************************************************************************/