...
package tp_archiservices_icy.csv_import_0_1;
...
/**
 * Job: CSV_Import Purpose: Importer des utilisateurs dans la base de données
 * depuis des fichiers CSV<br>
 * Description: <br>
 * 
...
public class CSV_Import implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(CSV_Import.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = CSV_Import.class.getClassLoader()
					.getResourceAsStream("tp_archiservices_icy/csv_import_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = CSV_Import.class.getClassLoader()
	...
	public static class db_inputStruct implements routines.system.IPersistableRow<db_inputStruct> {
		final static byte[] commonByteArrayLock_TP_ARCHISERVICES_ICY_CSV_Import = new byte[0];
		static byte[] commonByteArray_TP_ARCHISERVICES_ICY_CSV_Import = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TP_ARCHISERVICES_ICY_CSV_Import.length) {
					if (length < 1024 && commonByteArray_TP_ARCHISERVICES_ICY_CSV_Import.length == 0) {
						commonByteArray_TP_ARCHISERVICES_ICY_CSV_Import = new byte[1024];
					} else {
						commonByteArray_TP_ARCHISERVICES_ICY_CSV_Import = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TP_ARCHISERVICES_ICY_CSV_Import, 0, length);
				strReturn = new String(commonByteArray_TP_ARCHISERVICES_ICY_CSV_Import, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TP_ARCHISERVICES_ICY_CSV_Import, 0, length);
				strReturn = new String(commonByteArray_TP_ARCHISERVICES_ICY_CSV_Import, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TP_ARCHISERVICES_ICY_CSV_Import) {
		 ...
		 * Compare keys
		 */
		public int compareTo(db_inputStruct other) {
	...
	public void tFileList_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				db_inputStruct db_input = new db_inputStruct();
				...
				String directory_tFileList_1 = "C:/Users/antag/Documents/cours/5A/P2/archi_services/TP/csv_files";
				...
				for (int i_tFileList_1 = 0; i_tFileList_1 < list_tFileList_1.size(); i_tFileList_1++) {
					...
					if (execStat) {
						runStat.updateStatOnConnection("db_input", 3, 0);
					}
					...
					if (execStat) {
						runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "db_input");
					}
					...
					final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
							"enc:routine.encryption.key.v1:Jca52MGoRZMAP8hppjhuol6OnizAFnC8o+UYhWzqaO4ENrFb");
...
// # Outputs initialization
					db_inputStruct db_input_tmp = new db_inputStruct();
					db_inputStruct db_input_save = null;
// ###############################
					...
					try {
						...
						while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
							...
							try {
								...
								row1.login = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
// # Output table : 'db_input'
									db_input_tmp.nom = row1.nom;
									db_input_tmp.prenom = row1.prenom;
									db_input_tmp.login = row1.login;
									db_input_tmp.password = row1.password;
									db_input = db_input_tmp;
// ###############################
...
// Start of branch "db_input"
								if (db_input != null) {
									...
									if (db_input.nom == null) {
										pstmt_tDBOutput_1.setNull(1, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(1, db_input.nom);
									}

									if (db_input.prenom == null) {
										pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(2, db_input.prenom);
									}

									if (db_input.login == null) {
										pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(3, db_input.login);
									}

									if (db_input.password == null) {
										pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
									} else {
										pstmt_tDBOutput_1.setString(4, db_input.password);
									}
					...
					if (execStat) {
						runStat.updateStat(resourceMap, iterateId, 2, 0, "db_input");
					}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = CSV_Import.class.getClassLoader()
					.getResourceAsStream("tp_archiservices_icy/csv_import_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = CSV_Import.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CSV_Import");
		}
...
/************************************************************************************************
 * 67331 characters generated by Talend Open Studio for ESB on the 25 janvier
 * 2024, 08:36:13 CET
 ************************************************************************************************/